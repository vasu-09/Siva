...
import item4 from '../assets/electronics/crompton/torpdo-wht.webp';
     ...
     {/* DESKTOP VIEW */}
        <div className="d-none d-md-flex position-relative align-items-center py-5">
          ...
          <div style={{ position: 'absolute', left: '10px', zIndex: 2 }}>
            <img src={logo} alt="Goldmedal Logo"  style={{ width: '20%', height: 'auto' }} />
          </div>
          ...
          >
            <div className="row justify-content-center">
              ...
              <div className="col-6 col-md-2 mb-4 text-center">
                <img src={item1}  style={{ width: '35%', height: 'auto', marginLeft:'70px' }} className="img-fluid mb-2" alt="Wires" />
//               <h6 style={{marginLeft:'70px'}}>  {language == 'telugu' ? 'స్టాండ్ ఫాన్స్' :'Stand Fans'}</h6>
              </div>
              <div className="col-6 col-md-2 mb-4 text-center">
                <img src={item2} style={{ width: '70%', height: 'auto' }} className="img-fluid mb-2" alt="Switches" />
          ...
          <div className="container">
            <div className="row g-3">
              <div className="col-6 text-center">
                <div className="p-2">
                  <img src={item1} className="img-fluid mb-2" alt="Wires"  style={{width:'50%'}}/>
